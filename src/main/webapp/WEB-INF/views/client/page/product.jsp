                                  ...
                                  <circle class="path" fill="none"
										...
										<template>
											...
											<svg xmlns="http://www.w3.org/2000/svg" fill="none"
												...
												class="icon icon-unavailable" fill="none"
												viewBox="0 0 20 20">
...
.st0 {
	...
	stroke-miterlimit: 10;
									...
									<a href="affinity-m20.html"
										class="link product__view-details animate-arrow"> View
										full details <svg viewBox="0 0 14 10" fill="none"
											aria-hidden="true" focusable="false" role="presentation"
  ...
  <path
							...
							<div class="product-media-modal__content gradient"
								role="document" aria-label="Media gallery" tabindex="0">
								<img
					...
					<div class="product__info-as-bottom-tabs">
						<div class="product__info-bottom tabs">
							...
							<a class="summary__title tablinks"
	...
	display: none
										...
										<div class='jdgm-rev-widg__body'>
											<div class='jdgm-rev-widg__reviews'>
												...
												<div class='jdgm-rev jdgm-divider-top'
													...
													<div class='jdgm-rev__content'>
														<div class='jdgm-rev__custom-form'></div>
														<b class='jdgm-rev__title'>Sed elementum tempus
															egestas</b>
														<div class='jdgm-rev__body'>
						...
						<div class="dt-sc-tabs-content rte" id="tab-description"
							...
							<p>
								<span style="font-weight: 400;"
									data-mce-style="font-weight: 400;">Mobile phones are
									pivotal in our daily lives. Living without a mobile phone is
									challenging in this contemporary environment. A mobile phone is
									a broadband network that is a compact, small device used to
									send and receive speech, video, and other data types. Mobile
									phone usage offers additional benefits and features.</span>
							</p>
							<p>
								<b>Design and Build</b>
							</p>
							<p>
								It distinguishes out from the other smartphone competitors
								because of its fresh, sophisticated color Ocean Blue, which when
								combined with TFT LCD Display, gives it a luxurious appearance.
								Its approximate weight is <span style="font-weight: 400;"
									data-mce-style="font-weight: 400;">195.00 g dimensions
									are 164.5 x 76.9 x 8.4mm making it convenient and comfortable
									to hold. This phone includes Bluetooth and GPS connectivity as
									well as expandable storage.</span>
							</p>
							<p>
								<b>Display and Screen</b><br>
							</p>
							<p>
								A 6.30-inch screen with a resolution of 1080x2340 pixels
								displays all types of entertainment great, and the colors appear
								to be rather realistic. Standard Wi-Fi is supported up to 802.11
								b/g/n with Type-C USB. As its vendor Sensors like Face unlock,
								Fingerprint, Proximity and Accelerometer are supported. The
								speaker grill and audio jack are located at the bottom.<br>
							</p>
							<p>
								<b>Hardware and Performance</b><br>
							</p>
							<p>
								The latest smartphone features a 14nm chipset-based 1.8GHz
								Octa-core Exynos 7904 processor with 4GB of RAM and 64GB of
								storage. <span style="font-weight: 400;"
									data-mce-style="font-weight: 400;">The 5000mAh battery
									is compatible with the Aspect ratio 19.5:9.The phone is among
									the best performances in its category because of this
									combination. On low-end hardware, the Experience UI for phones
									has been tuned to operate without a hitch. The icons and
									appearance are nearly identical to One UI. The software is
									reliable, sophisticated, and enjoyable. </span>
							</p>
						</div>
						<div class="dt-sc-tabs-content rte" id="shipping-returns">
							...
							<p>
								...
								will receive a refund more quickly. This time period includes
								...
								return once we receive it (3 to 5 business days), and the time
								it takes your bank to process our refund request (5 to 10
								business days).
							</p>
							<p>
  ...
  <path
								...
								<form method="post"
									...
									<input autocomplete="email" type="email" id="ContactForm-email"
										...
										id="ContactFormPhone" name="contact[Phone]"
										placeholder="Phone" />
...
.enquiry-modal .enquiry-content .contact-form>#ContactFormName,
  ...
  <path fill-rule="evenodd" clip-rule="evenodd"
										...
										<input class="quantity__input" type="number" name="quantity"
											id="Quantity-template--16769564246116__main" min="1"
											value="1" form="">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd"
									...
									<div class="product-form__input product-form__input--dropdown">
										<label class="form__label"
											for="Option-template--16769564246116__main-0"> Color
										</label>
										<div class="select">
										...
										<div class="select">
											<select id="Option-template--16769564246116__main-2"
												class="select__select" name="options[Storage+RAM]" form=""><option
													value="128 GB+8 GB" selected="selected">128 GB+8
													GB</option></select>
											<svg aria-hidden="true" focusable="false" role="presentation"
												class="icon icon-caret" viewBox="0 0 10 6">
  <path fill-rule="evenodd" clip-rule="evenodd"
