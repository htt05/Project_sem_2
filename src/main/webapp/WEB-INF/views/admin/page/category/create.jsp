		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<!-- form start -->
					<f:form
						action="${pageContext.servletContext.contextPath}/admin/category/add"
						method="POST" role="form" modelAttribute="cat">
						<div class="box-body">
							<div class="form-group">
								<label for="category_name">Tên danh mục</label>
								<f:input path="catName" type="text" class="form-control"
									id="category_name" value="${ cat.catName }"
									onkeyup="ChangeToSlug()" />
								<f:errors cssClass="text-danger" path="catName"></f:errors>
							</div>
							<f:hidden path="slug" class="form-control" id="slug"
								value="${ cat.slug }" />
							<div class="form-group">
